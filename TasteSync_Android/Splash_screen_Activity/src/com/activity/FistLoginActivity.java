...
public class FistLoginActivity extends Activity {
	...
	String[] cuisine = { "African", "Asian", "European", "Oceanian", "Americas" };
	String[] restaurants = { "Back Forty West", "ABC Kitchen", "Blue Hill",
			" The Dutch", "Fedora" };
	...
	private void init() {
		...
		// au_restaurant4 = (AutoCompleteTextView)
		// findViewById(R.id.auto_login_single_restaurant_4);
		// au_restaurant5 = (AutoCompleteTextView)
		// findViewById(R.id.auto_login_single_restaurant_5);
	}
		...
		btn_done.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (CheckNotnull()) {
					...
					Toast.makeText(FistLoginActivity.this,
							"Please Insert full info", 1000).show();
				}
			}
		});
