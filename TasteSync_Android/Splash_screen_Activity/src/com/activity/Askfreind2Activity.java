...
public class Askfreind2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_done.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				Intent mIntent = new Intent(Askfreind2Activity.this,
//						RestaurantsActivity.class);
//				TabGroupActivity parent = (TabGroupActivity)getParent();
//				parent.startChildActivity("RestaurantsActivity", mIntent);
				RestaurantGroupActivity.group.onBackPressed();
			}
		});
		objAdapter = new AdapterContact(Askfreind2Activity.this,
