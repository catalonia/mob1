...
import com.activity.Recommandations3Activity;
...
public class showRecommandActivity3 extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View view2 = getLayoutInflater().from(this).inflate(R.layout.tab_recom,
				null);
		Intent recomdIntent = new Intent(this, Recommandations3Activity.class);
		recivedata();
