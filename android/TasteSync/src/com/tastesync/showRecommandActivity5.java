...
import com.activity.Recommandations5Activity;
...
public class showRecommandActivity5 extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View view2 = getLayoutInflater().from(this).inflate(R.layout.tab_recom,
				null);
		Intent recomdIntent = new Intent(this, Recommandations5Activity.class);
		recivedata();
