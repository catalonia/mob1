...
import com.activity.Recommandations1Activity;
...
public class showRecommandActivity1 extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View view2 = getLayoutInflater().from(this).inflate(R.layout.tab_recom,
				null);
		Intent recomdIntent = new Intent(this, Recommandations1Activity.class);
		recivedata();
