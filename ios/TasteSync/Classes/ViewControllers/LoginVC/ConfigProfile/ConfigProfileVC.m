...
//    CRequest* request = [[CRequest alloc]initWithURL:@"showProfileFriends" RQType:RequestTypePost RQData:RequestDataUser RQCategory:ApplicationForm withKey:11 WithView:self.view];
...
//    CRequest* request = [[CRequest alloc]initWithURL:@"loginAccount" RQType:RequestTypePost RQData:RequestDataUser RQCategory:ApplicationForm withKey:15 WithView:self.view];
//    request.delegate = self;
//    [request setFormPostValue:[UserDefault userDefault].userID forKey:@"userId"];
//    [request startFormRequest];
    
//    CRequest* request2 = [[CRequest alloc]initWithURL:@"showProfileFriends" RQType:RequestTypePost RQData:RequestDataUser RQCategory:ApplicationForm withKey:16 WithView:self.view];
