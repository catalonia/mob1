...
- (id)init
{
    ...
    else
    {
        if ([CommonHelpers isPhone5]) {
            frame = CGRectMake(([[UIScreen mainScreen] bounds].size.width-[[UIScreen mainScreen] bounds].size.height)/2, - 20, [[UIScreen mainScreen] bounds].size.height, [[UIScreen mainScreen] bounds].size.height);
        }
        else
        {
            frame = CGRectMake(([[UIScreen mainScreen] bounds].size.width-[[UIScreen mainScreen] bounds].size.height)/2, 7, [[UIScreen mainScreen] bounds].size.height, [[UIScreen mainScreen] bounds].size.height);
        }
    }
...
//        ProgressLbl = [[UILabel alloc] initWithFrame:CGRectMake((self.frame.size.width-200)/2, self.frame.size.height/2 - 65, 200, 40.0)];
//        ProgressLbl.font = [UIFont boldSystemFontOfSize:20.0];
//        ProgressLbl.text = @"0%";
...
- (void)setProgress:(NSNumber*)value{
    ...
    [self.delegate didFinishForNumber:self ForPath:value];
}
